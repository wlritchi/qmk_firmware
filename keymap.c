...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_moonlander(
        ...
        KC_TRANSPARENT, KC_NO, KC_KP_DOT, KC_TRANSPARENT, KC_TRANSPARENT,
    ...
    [4] = LAYOUT_moonlander(
        ...
        KC_RIGHT, KC_END, KC_TRANSPARENT, MO(5), KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
    [0] = {{126, 255, 255}, {126, 255, 255}, {126, 255, 255}, {43, 255, 255},
