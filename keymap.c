...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_moonlander(
        ...
        LM(1, MOD_LSFT), KC_SCOLON, KC_Q, KC_X, KC_J, KC_K, KC_B, KC_M, KC_W,
        KC_V, KC_Z, KC_RSHIFT, MOON_LED_LEVEL, KC_LGUI, KC_LALT,
        LM(5, MOD_LSFT), MO(4), KC_LALT, MT(MOD_LCTL, KC_ESCAPE), MO(4),
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_SPACE, LM(1, MOD_LSFT), MT(MOD_LCTL, KC_ESCAPE), KC_TAB, KC_BSPACE,
        KC_ENTER),
    [1] = LAYOUT_moonlander(
        ...
        KC_RABK, LSFT(KC_P), LSFT(KC_Y), MO(5), KC_BSLASH, LSFT(KC_F),
        ...
        KC_UNDS, KC_TRANSPARENT, KC_COLN, LSFT(KC_Q), LSFT(KC_X), LSFT(KC_J),
        LSFT(KC_K), LSFT(KC_B), LSFT(KC_M), LSFT(KC_W), LSFT(KC_V), LSFT(KC_Z),
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    ...
    [2] = LAYOUT_moonlander(
        ...
        KC_NO, KC_F12, LM(3, MOD_LSFT), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        ...
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, LM(3, MOD_LSFT),
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT),
    [3] = LAYOUT_moonlander(
    ...
    [4] = LAYOUT_moonlander(
        ...
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_NO, KC_TRANSPARENT, KC_HOME, KC_LEFT, KC_DOWN,
        KC_RIGHT, KC_END, KC_TRANSPARENT, LM(5, MOD_LSFT), KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, LM(5, MOD_LSFT),
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT),
    [5] = LAYOUT_moonlander(
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
