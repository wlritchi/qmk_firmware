...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_moonlander(
        ...
        KC_L, KC_SLASH, LM(6, MOD_LCTL), KC_A, KC_O, KC_E, KC_U, KC_I, MO(2),
        KC_AT, KC_D, KC_H, KC_T, KC_N, KC_S, KC_MINUS, MO(1), KC_SCLN, KC_Q,
        KC_X, KC_J, KC_K, KC_B, KC_M, KC_W, KC_V, KC_Z, KC_RIGHT_SHIFT,
    ...
    [1] = LAYOUT_moonlander(
        ...
        KC_RABK, LSFT(KC_P), LSFT(KC_Y), MO(5), KC_BSLS, LSFT(KC_F), LSFT(KC_G),
    ...
    [6] = LAYOUT_moonlander(
        ...
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, LGUI(KC_A), KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        LGUI(KC_S), KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, LGUI(KC_X), KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, LGUI(KC_V),
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
